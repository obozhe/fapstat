export default (name: string, code: string) => `<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8" />
        ...
        @font-face {
          ...
          src: url("../fonts/montserrat-v25-latin-700.eot?#iefix")
            ...
            /* Modern Browsers */ url("../fonts/montserrat-v25-latin-700.ttf")
              format("truetype"),
            /* Safari, Android, iOS */
              url("../fonts/montserrat-v25-latin-700.svg#Montserrat")
              format("svg"); /* Legacy iOS */
        }
        @font-face {
   ...
   */
      ...
      a {
        ...
        font-family: "Montserrat", "Source Sans Pro", Helvetica, Arial,
          sans-serif;
      }
      /**
  ...
  <body style="background-color: #e9ecef">
    ...
    <div
      ...
      "
    >
      Open the mail to find the confirmation code and verify your actions.
    </div>
    <!-- end preheader -->
          ...
          >
            ...
            <tr>
              ...
              >
                ...
                <p style="margin: 0">Find your confirmation code below.</p>
              </td>
            </tr>
            <!-- end copy -->
                    ...
                    <td align="center" bgcolor="#ffffff" style="padding: 12px">
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td
                            align="center"
                            style="border-radius: 6px; font-size: 32px"
                          >
                            ${code}
                          </td>
                        </tr>
            ...
            <tr>
              <td
                ...
                style="padding: 24px; font-size: 16px; line-height: 24px"
              >
                <p style="margin: 0">Code expires in 3 minutes.</p>
              </td>
            </tr>
            <!-- end copy -->
            ...
            <tr>
              ...
              >
                <p style="margin: 0">
                  ...
                  action confirmation for your account. If you didn't request it
